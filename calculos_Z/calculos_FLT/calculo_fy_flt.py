...
def calcular_fy_flt(perfil_z, fy, Ly, Lz, Cb):
    """
    ...
    rx = perfil_z["rx"]  # Raio de giração em torno de x (cm)
    ry = perfil_z["ry"]  # Raio de giração em torno de y (cm)
    Ix = perfil_z["Ix"]  # Momento de inércia principal em y (cm⁴)
    Cw = perfil_z["Cw"]  # Constante de empenamento (cm⁶)
    J = perfil_z["J"]    # Constante de torção (cm⁴)
    Wx = perfil_z["Wx"]  # Módulo de resistência em x (cm³)
