...
def calcular_mesa(perfil, fy_flt, yg1):
    ...
    # 📌 Cálculo de lambda
    lambda_val = bf / t
    lambda_p0 = lambda_val / (0.623 * math.sqrt(20000 / fy_flt))
    ...
    if lambda_p0 < 0.673:
        ...
        lambda_p = lambda_val / (0.95 * math.sqrt(k * 20000 / fy_flt))  # 🔹 Agora sempre será definido
        ...
        if lambda_p < 0.673:
            ...
            yg1 = yg0 + y1
            ixret2 = ((t * (lret1 ** 3)*(math.sin(math.radians(45))**2)) / 12) + (Aret1 * (d1 ** 2))
            yg2=yg1
        else:
            # 📌 Cálculo do enrijecedor efetivo
            ...
            y1 = (d1 * Aret1) / Aef1 if Aef1 != 0 else 0
            yg1 = yg0 + y1
            ixret1 = ((t * (lret1 ** 3)*(math.sin(math.radians(45))**2)) / 12) + (Aret1 * (d1 ** 2))
