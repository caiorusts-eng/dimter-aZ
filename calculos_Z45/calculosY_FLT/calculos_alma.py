...
def calcular_alma(perfil, fy_flt, xg2, Aef2, lret1, def_efetiva):
    ...
    if xg0 == xg0_inicial:
        sigma_a = t * fy_flt / (2*xg0_inicial) 
    else:
        sigma_a =abs((xg0 - (bf + 2 * t + 2*t*math.tan(math.radians(45/2)) + def_efetiva*math.sin(math.radians(45))))*fy_flt / xg0)
